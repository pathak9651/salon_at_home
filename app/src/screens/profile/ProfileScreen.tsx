...
function createStyles(colors: ThemeColors) {
  ...
  hero: { flexDirection: "row", alignItems: "center", padding: 17, borderWidth: 1, borderColor: colors.heroBorder, borderRadius: 8, backgroundColor: colors.panelRaised },
  ...
  menuRow: { minHeight: 72, flexDirection: "row", alignItems: "center", gap: 18, paddingHorizontal: 24, borderBottomWidth: 1, borderBottomColor: colors.border, borderRadius: 8, backgroundColor: colors.panel },
  ...
  inlinePanel: { paddingHorizontal: 20, paddingVertical: 16, borderBottomWidth: 1, borderBottomColor: colors.border, borderRadius: 8, backgroundColor: colors.bar },
  ...
  input: { color: colors.text, padding: 13, borderWidth: 1, borderColor: colors.border, borderRadius: 8, backgroundColor: colors.panel, fontSize: 13 },
  messageInput: { color: colors.text, minHeight: 92, padding: 13, borderWidth: 1, borderColor: colors.border, borderRadius: 8, backgroundColor: colors.panel, fontSize: 13, textAlignVertical: "top" },
  ticketRow: { flexDirection: "row", alignItems: "center", gap: 10, padding: 12, marginBottom: 8, borderWidth: 1, borderColor: colors.border, borderRadius: 8, backgroundColor: colors.panel },
  ...
  chatPanel: { padding: 10, marginBottom: 14, borderWidth: 1, borderColor: colors.border, borderRadius: 8, backgroundColor: colors.panel },
  myMessage: { alignSelf: "flex-end", maxWidth: "84%", padding: 10, marginBottom: 8, borderRadius: 8, backgroundColor: colors.activePanel },
  theirMessage: { alignSelf: "flex-start", maxWidth: "84%", padding: 10, marginBottom: 8, borderWidth: 1, borderColor: colors.border, borderRadius: 8, backgroundColor: colors.bar },
  ...
  membershipActive: { padding: 12, marginBottom: 12, borderWidth: 1, borderColor: colors.green, borderRadius: 8, backgroundColor: colors.successPanel },
  planCard: { padding: 14, marginBottom: 12, borderWidth: 1, borderColor: colors.border, borderRadius: 8, backgroundColor: colors.panel },
  ...
  row: { padding: 14, marginBottom: 9, borderWidth: 1, borderColor: colors.border, borderRadius: 8, backgroundColor: colors.panel },
  ...
  primary: { alignSelf: "flex-start", alignItems: "center", justifyContent: "center", minHeight: 36, marginTop: 7, paddingVertical: 9, paddingHorizontal: 16, borderRadius: 8, backgroundColor: colors.cyan },
  primaryText: { color: colors.buttonText, fontWeight: "900", fontSize: 9, letterSpacing: 1 },
  secondary: { alignItems: "center", padding: 12, marginTop: 10, borderWidth: 1, borderColor: colors.cyan, borderRadius: 8 },
  ...
  addressCard: { padding: 14, marginBottom: 9, borderWidth: 1, borderColor: colors.border, borderRadius: 8, backgroundColor: colors.panel },
  ...
  addressForm: { padding: 14, marginTop: 8, borderWidth: 1, borderColor: colors.border, borderRadius: 8, backgroundColor: colors.bar },
  locationButton: { alignSelf: "flex-end", width: 44, height: 44, alignItems: "center", justifyContent: "center", marginBottom: 10, borderWidth: 1, borderColor: colors.cyan, borderRadius: 8, backgroundColor: colors.panel },
  twoColumns: { flexDirection: "row", gap: 10 },
  checkbox: { flexDirection: "row", alignItems: "center", gap: 10, marginTop: 4, marginBottom: 6 },
  checkboxBox: { width: 18, height: 18, borderWidth: 1, borderColor: colors.border, borderRadius: 5 },
  ...
  logout: { alignItems: "center", marginTop: 21, padding: 14, borderWidth: 1, borderColor: colors.danger, borderRadius: 8, backgroundColor: colors.dangerPanel },
