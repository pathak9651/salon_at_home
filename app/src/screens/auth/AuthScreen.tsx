...
function createStyles(colors: ThemeColors) {
  return StyleSheet.create({
    flex: { flex: 1 }, page: { flexGrow: 1, justifyContent: "center", padding: 24 }, eyebrow: { color: colors.cyan, fontSize: 9, letterSpacing: 1.8 }, title: { color: colors.text, fontSize: 32, fontWeight: "800", marginTop: 10 }, subtitle: { color: colors.muted, fontSize: 13, lineHeight: 20, marginTop: 7, marginBottom: 22 }, tabs: { flexDirection: "row", borderWidth: 1, borderColor: colors.border, borderRadius: 8, backgroundColor: colors.panel }, accountTypes: { flexDirection: "row", gap: 10, marginTop: 14, marginBottom: 4 }, tab: { flex: 1, alignItems: "center", padding: 13, borderWidth: 1, borderColor: "transparent", borderRadius: 8 }, tabActive: { borderColor: colors.cyan, backgroundColor: colors.activePanel }, tabText: { color: colors.muted, fontSize: 10, fontWeight: "800", letterSpacing: 1.2 }, tabTextActive: { color: colors.cyan }, field: { marginTop: 15 }, label: { color: colors.amber, fontSize: 9, fontWeight: "800", letterSpacing: 1.2, marginBottom: 7 }, input: { color: colors.text, padding: 13, borderWidth: 1, borderColor: colors.border, borderRadius: 8, backgroundColor: colors.panel, fontSize: 13 }, notice: { color: colors.green, fontSize: 11, lineHeight: 17, marginTop: 14 }, error: { color: colors.danger, fontSize: 11, marginTop: 14 }, primary: { alignItems: "center", justifyContent: "center", minHeight: 44, marginTop: 18, padding: 12, borderRadius: 8, backgroundColor: colors.cyan }, primaryText: { color: colors.buttonText, fontWeight: "900", fontSize: 10, letterSpacing: 1.2 }, link: { color: colors.cyan, textAlign: "center", fontSize: 10, fontWeight: "800", letterSpacing: 1, marginTop: 17 }, note: { color: colors.muted, textAlign: "center", fontSize: 10, marginTop: 16 },
  });
}
