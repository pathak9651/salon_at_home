...
function createStyles(colors: ThemeColors) {
  return StyleSheet.create({
    ...
    card: { padding: 14, marginBottom: 8, borderWidth: 1, borderColor: colors.border, backgroundColor: colors.panel },
    ...
    actionButton: { minHeight: 36, justifyContent: "center", paddingHorizontal: 12, borderWidth: 1, borderColor: colors.border },
